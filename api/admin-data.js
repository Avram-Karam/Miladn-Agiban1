...
const DEFAULT_GAS_URL = 'https://script.google.com/macros/s/AKfycbzTq2wFN35ZvwNdMpx7_DlZLQhZIQH0HRZ2e1p_HhcjLItG7c_SfXM_OaNPilG4UcwDFg/exec';
...
function verifyToken(token) {
  try {
    ...
    return username === (process.env.ADMIN_USERNAME || 'admin') && age >= 0 && age <= SESSION_TTL_MS;
...
export default async function handler(req,res){
  ...
  const GAS_TOKEN=process.env.GAS_TOKEN || 'YC2026_SECURE_TOKEN_8921';
  try{
